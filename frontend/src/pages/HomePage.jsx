...
export default function HomePage({ profile, navigate, onLogout, loggingOut, logoutError, session, setSession, active = true, onPresenceError }) {
  ...
  async function start(event) {
    ...
    try {
      await startStudySession({ classes: selected, location, comments: additionalInfo, durationMinutes });
      setSession({ durationMinutes, durationIsMinimum: durationMinutes === 120, classes: [...selected], location: location.trim() || 'Kennedy Library' });
