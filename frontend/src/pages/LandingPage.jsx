  ...
  return <div className="landing">
    ...
    <header className="lp-header lp-container">
      ...
      <nav className="lp-nav" aria-label="Main navigation">
        ...
        <a className="lp-button" href="/signup" onClick={navigate}>Sign up <span aria-hidden="true">↗</span></a>
      </nav>
    </header>
    <main id="main-content">
      <section className="lp-hero lp-container" aria-labelledby="landing-title">
        ...
        <a className="lp-button" href="/signup" onClick={navigate}>Get started <span aria-hidden="true">↗</span></a>
      </section>
