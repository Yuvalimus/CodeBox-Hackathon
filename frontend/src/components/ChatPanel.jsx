...
export default function ChatPanel({ profile, initialChatId, onUnmatch }) {
  ...
  function formatStudyTime(slot) {
    const day = ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'][Math.floor(slot / 24)];
    const hour = slot % 24;
