...
export default function AvatarArt({ avatar = 'sage', label = 'Avatar' }) {
  ...
  return <svg viewBox={`${x} ${y} 120 131`} preserveAspectRatio="xMidYMid slice" role="img" aria-label={label} style={{ display: 'block', width: '100%', height: '100%', overflow: 'hidden' }}><image href="/avatars/avatar-reference.png" width="309" height="496" /></svg>;
}
